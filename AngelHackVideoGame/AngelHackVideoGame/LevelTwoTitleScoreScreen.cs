...
{
    public class AngelScoreScreenLevelTwo : GameScreen
    {
        ...
        int points;
        public AngelScoreScreenLevelTwo(int newPoints)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if ((Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Enter)))
            {
                ...
                ScreenManager.angelhacktotalscore = new AngelHackTotalScore();
                ScreenManager.Instance.AddScreen(ScreenManager.angelhacktotalscore);
