...
{
    public class RandomAppearLeapLevelTwo : GameScreen
    {
        ...
        public RandomAppearLeapLevelTwo()
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                ScreenManager.Instance.AddScreen(new AngelScoreScreenLevelTwo(hitPoints));
            ...
            else if (gameEngineTime == 13)
            {
                isTimeInterval = false;
            }

            //
            if (gameTime.TotalGameTime.Seconds > (controlBackgroundSwitch + .5))
            {
